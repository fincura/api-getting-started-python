...
class FilesApi(object):
    ...
    def create_document_file(self, **kwargs):  # noqa: E501
        ...
        :param DocumentFileCreate document_file_create:
        ...
        return self.create_document_file_with_http_info(**kwargs)  # noqa: E501

    def create_document_file_with_http_info(self, **kwargs):  # noqa: E501
        """Submit a new DocumentFile  # noqa: E501

        Add a new file to Fincura for processing.  The minimal document creation request requires just a borrower_uuid and the media_type of the file to process.       POST /v1/document-file HTTP/1.1     Host: api-local.fincura.com:8000     Accept: application/json     Authorization: Bearer eyJ0e...nFTRKTbcg     Content-Type: application/json      {         \"borrower_uuid\": \"6e64724a-25fc-4e1a-8071-1ef29845ab1d\",         \"media_type\": \"application/pdf\"\"     }       The above request will create a new document record in Fincura and return a url to send the file to, as seen below.      {         \"uuid\": \"18ef4ec9-b313-49a3-81c6-8c486f956df3\",         \"upload_url\": \"https://upload.fincura.com/18ef4ec9-b313-49a3-81c6-8c486f956df3/document.pdf?signature=mWFg4xsgm4EtFEt\"     }  In a subsequent request, the file can be sent to the `upload_url` via [HTTP PUT](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/PUT). The `Content-Length` and `Content-Type` headers are required. The `Content-Type` should match the `media_type` from the previous request.      PUT /18ef4ec9-b313-49a3-81c6-8c486f956df3/document.pdf?signature=mWFg4xsgm4EtFEt HTTP/1.1     Host: upload.fincura.com     Content-Length: 18828     Content-Type: application/pdf          {FILE  DATA}  Fincura will begin processing the file once it has been completely uploaded.  Additional fields described below:  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_document_file_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DocumentFileCreate, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method create_document_file" % key
                )
        ...
        body_params = None
        if 'document_file_create' in local_var_params:
            body_params = local_var_params['document_file_create']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='DocumentFileCreate',  # noqa: E501
    ...
    def destroy_document_file(self, uuid, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.destroy_document_file_with_http_info(uuid, **kwargs)  # noqa: E501

    def destroy_document_file_with_http_info(self, uuid, **kwargs):  # noqa: E501
        """Delete a DocumentFile  # noqa: E501

        Delete a file from Fincura.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.destroy_document_file_with_http_info(uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method destroy_document_file" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('uuid' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `uuid` when calling `destroy_document_file`")  # noqa: E501
    ...
    def list_document_files(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_document_files_with_http_info(**kwargs)  # noqa: E501

    def list_document_files_with_http_info(self, **kwargs):  # noqa: E501
        """List DocumentFile records  # noqa: E501

        List files submitted to Fincura  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_document_files_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_document_files" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def retrieve_document_file(self, uuid, **kwargs):  # noqa: E501
        """Get the status of a submitted DocumentFile  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.retrieve_document_file_with_http_info(uuid, **kwargs)  # noqa: E501

    def retrieve_document_file_with_http_info(self, uuid, **kwargs):  # noqa: E501
        """Get the status of a submitted DocumentFile  # noqa: E501

        Retrieve a file submitted to Fincura  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_document_file_with_http_info(uuid, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DocumentFileRead, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method retrieve_document_file" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'uuid' is set
        if self.api_client.client_side_validation and ('uuid' not in local_var_params or  # noqa: E501
                                                        local_var_params['uuid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `uuid` when calling `retrieve_document_file`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DocumentFileRead',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
